/**
 * dynamicWaveCanvas.js
 * High-performance 2D Canvas-based plasma/wave animation.
 * Replicates the "dynamic-wave-canvas-background" shader math.
 * Mounts directly into the .global-background container.
 */
(function () {
  "use strict";

  function init() {
    const container = document.querySelector(".global-background");
    if (!container) return;

    /* Clear any existing contents (like the WebGL canvas) */
    container.innerHTML = "";
