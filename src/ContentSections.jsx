        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 font-body text-sm leading-relaxed text-white/85">
              ...
              <a href="tel:+919307133407" className="hover:text-white transition-colors">9307133407</a>
            </p>
            <div className="mt-auto pt-6 flex items-center justify-between">
              <a href="tel:+919307133407" className="font-body text-xl font-medium tracking-wide text-white hover:text-white/80 transition-colors">
                9307133407
              </a>
              <div className="flex gap-2">
                <a href="tel:+919307133407" className="liquid-glass rounded-full px-3 py-1.5 font-body text-[11px] text-white/90 hover:text-[#00f0ff] transition-colors duration-200">Call</a>
